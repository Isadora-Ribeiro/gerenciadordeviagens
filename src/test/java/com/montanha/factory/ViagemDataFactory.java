...
public class ViagemDataFactory {
    public static Viagem criarViagem() throws IOException {
        ...
        Viagem viagem = objectMapper.readValue(new FileInputStream("C:\\projects\\gerenciador-viagens-master\\src\\test\\resources\\requestBody\\postV1Viagens.json"), Viagem.class);
        return viagem;
    }
