...
public class ViagensTest {
    ...
    public void testCadastroDeViagemValidaRetornaSucesso() throws IOException {
        ...
        .then()
            .assertThat()
              .statusCode(201)
            .body("data.localDeDestino", equalTo("Alagoas"))
                  .body("data.acompanhante", equalTo("Nelson"));
    }
    ...
    @Test
    public void testCadastroDeViagemContrato() throws IOException {
        Viagem viagemValida = ViagemDataFactory.criarViagemValida();
        ...
        .then()
                .assertThat()
                .statusCode(201)
                .body(matchesJsonSchemaInClasspath("schemas/postV1ViagensViagemValiada.json"));
    }

    @Test
    public void testRetornaViagemPossuiStatusCode200EMostralocalDeDestino(){
        given()
    ...
    public void testViagemProcessaCorretamenteORetornoDaAPIDoTempo(){
        ...
        .then()
            .assertThat()
                .statusCode(200)
                .body("data.temperatura", equalTo(39.46f));
